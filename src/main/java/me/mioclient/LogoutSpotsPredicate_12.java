...
/* loaded from: mio-yarn.jar:me/mioclient/LogoutSpotsPredicate_12.class */
public class LogoutSpotsPredicate_12 implements java.util.function.Predicate {
    public LogoutSpots logoutSpots;

    public LogoutSpotsPredicate_12(LogoutSpots logoutSpots) {
