...
/* loaded from: mio-yarn.jar:me/mioclient/ShaderFramebufferHelper_4.class */
public class ShaderFramebufferHelper_4 extends ShaderFramebufferHelper {
    ...
    public ShaderFramebufferHelper_4() {
        do753("bloom");
    }

    @Override // me.mioclient.FramebufferHelper
    public boolean is755() {
        return shader.isToggled() && shader.shader.getValue() == Shader.MixinHeldItemRendererMode.BLOOM;
    }
    ...
    public void do759() {
        ...
        this.framebufferHelper_3.do1439("u_GlowQuality", shader.quality.getValue().intValue());
        this.framebufferHelper_3.do1442("u_FillColor", shader.is3114() ? MixinMessageIndicatorHelper_2.getColor820(shader.outline2.getValue()) : shader.getColor3112(shader.fill.getValue()));
