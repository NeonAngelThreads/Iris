...
/* loaded from: mio-yarn.jar:me/mioclient/SpeedMinePredicate_3.class */
public class SpeedMinePredicate_3 implements java.util.function.Predicate {
    public SpeedMine speedMine;

    public SpeedMinePredicate_3(SpeedMine speedMine) {
