...
/* loaded from: mio-yarn.jar:me/mioclient/ElytraFlyPredicate_34.class */
public class ElytraFlyPredicate_34 implements java.util.function.Predicate {
    public ElytraFly elytraFly;

    public ElytraFlyPredicate_34(ElytraFly elytraFly) {
